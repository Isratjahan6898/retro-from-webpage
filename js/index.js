...
const displayCard = cards => {
    ...
    cards.forEach(card => {
        ...
        const indicatorStyle = card.isActive ? 'background-color: #00cc00' : ''
        showCard.innerHTML = `
        <figure>
            <div class="indicator">
      ...
      <div class="card-body">
        ...
        <div class="card-actions justify-between">
          ...
          <button onclick="displayCardTitle('${card.title}')"><i class="fa-regular fa-envelope text-center w-[40px] h-[40px] rounded-[50px] p-[8px] bg-[#10B981]" aria-hidden="true"></i></button>
...
const displayCardTitle = (title) => {
    ...
    titleCountElement.innerHTML = `Mark as read: ${titleCount}`;
}
